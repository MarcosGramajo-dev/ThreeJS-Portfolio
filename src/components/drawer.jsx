    ...
    <React.Fragment>
      ...
      <Drawer open={open} onClose={closeDrawer} className="bg-white">
        ...
        <List className="z-50 text-black">
          ...
          <ListItem onClick={() => linkMenu('https://www.linkedin.com/in/39-marcosgramajo/')}>
            <ListItemPrefix>
            <svg 
                xmlns="http://www.w3.org/2000/svg" 
                width="24" 
          ...
          <ListItem onClick={() => linkMenu('https://drive.google.com/file/d/1-qzUF_S_Z2siaJFrGDum1QR8Q5IXz2sK/view?usp=sharing')}>
            <ListItemPrefix>
            <svg 
                xmlns="http://www.w3.org/2000/svg" 
                width="24" 
